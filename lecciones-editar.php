        ...
        <div class="card-body">
            <form action="controller/LeccionesRegistroController.php" method="post">
                ...
                <div class="pt-3">
                    ...
                    <textarea class="form-control" name="descripcion" id="descripcion" rows="5" placeholder="Escriba la leccion aqui" oninput="contCaracteres('descripcion','count')" required><?php echo htmlspecialchars($leccion['descripcion']) ?></textarea>
                    <div id="count"></div>
                </div>
                <div class="row pt-3">
                    <div>
